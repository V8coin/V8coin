...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 360;	// stake age of full weight:  360d
unsigned int nStakeTargetSpacing = 120;			// 2 minutes block spacing

int64 nChainStartTime = 1404074847;
...
const string strMessageMagic = "Carcoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Carcoin
    bool fStrictPayToScriptHash = true; // Always active in Carcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Carcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "V8 is power!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x935ebcb031f2a8a5ef4fe27420b40ea338d1ff70d0d215f275e546e756b3a66e"));
...
unsigned char pchMessageStart[4] = { 0x63, 0x35, 0x22, 0xdb };
